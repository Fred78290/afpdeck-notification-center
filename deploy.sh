...
LAMBDA_BUCKET=afpdeck-notification-center-lambda
SAM_PROFILE=aldune
...
sam package ${SAM_OPTIONS} --template-file ${TEMPLATE} --output-template-file ${TEMPLATE}.out

sam deploy ${SAM_OPTIONS} --template-file ${TEMPLATE}.out \
